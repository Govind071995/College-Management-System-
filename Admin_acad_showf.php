...
<div class="col-xs-12 col-sm-4 col-lg-4">
        <div class="form-group field-stumaster-stu_master_nationality_id">
<label class="control-label" for="stumaster-stu_master_nationality_id">Blood Group</label><input id="blood_group" class="form-control" name="StuMaster[stu_master_nationality_id]"value="<?php echo $Blood; ?>"required>
</input><div class="help-block"></div>
</div>  </div>
...
xhr.open("GET","editfaculty.php?f_id=" + fid +"&first_name=" + fn +"&last_name=" + ln + "&degree=" + dg + "&degree_field=" + dgf + "&gender=" + gn +"&email=" + em + "&mobile_no=" + mb +"&city=" + city + "&joindate=" + jd + "&address=" + adr + "&bloodgroup=" + bg + "&state=" + state+ "&pin=" + pin + "&password=" + password, true);
xhr.send();
