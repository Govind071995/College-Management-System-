...
<label class="control-label" for="stuinfo-stu_guardian_mob_no">Guaridian Mobile No</label><input type="number" id="guardian_mob_no" class="form-control" name="guardian_mob_no" maxlength="12"><div class="help-block"></div>
  </div> </div>
   </div>
