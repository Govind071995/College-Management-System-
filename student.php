...
<label class="control-label" for="stuinfo-stu_blood_group">Blood Group</label><input type="text" id="stuinfo-stu_mother_name" class="form-control" name="mother_name" value="<?php echo $Blood; ?>" readonly><div class="help-block"></div>
</div>    </div>
   </div>
 </div>
 </section>                
