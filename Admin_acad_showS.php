...
<div class="col-xs-12 col-sm-4 col-lg-4">
        <div class="form-group field-stumaster-stu_master_nationality_id">
<label class="control-label" for="stumaster-stu_master_nationality_id">Blood Group</label><input id="blood_group" class="form-control" name="StuMaster[stu_master_nationality_id]"value="<?php echo $Blood; ?>">
</input><div class="help-block"></div>
</div>  </div>
<div class="col-xs-12 col-sm-4 col-lg-4">
        <div class="form-group field-stumaster-stu_master_nationality_id">
