...
<div class="box box-default">
	<div class="box-header with-border">
		<h3 class="box-title"><i class="glyphicon glyphicon-dashboard"></i> complain</h3>
	</div>
	<div class="box-body">
	...
	<!--	<div class="col-md-6 col-sm-6 col-xs-12">
		...
		<div class="col-md-6 col-sm-6 col-xs-12">
		      <div class="edusec-link-box">
		        ...
		        <div class="edusec-link-box-content">
		          <span class="edusec-link-box-text"><a href="?controller=student&action=view_complain_response&st_id=<?php echo $_SESSION['userid'] ?>">View Compain Response</a></span>
		          <span class="edusec-link-box-number"></span>
			<!-- <span class="edusec-link-box-desc">Manage Student/Employee Dashboard Notice</span>-->
			  <span class="edusec-link-box-bottom"><a href="?controller=student&action=submit_complain&st_id=<?php echo $_SESSION['userid'] ?>"><i class="fa fa-plus-square"></i> Submit Complain</a></span>
		        </div><!-- /.info-box-content -->
		      </div><!-- /.info-box -->
		</div>
