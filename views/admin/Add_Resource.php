...
<li><a href="?controller=admin&action=resource_distribution">Resource Detail</a></li>
...
<div class="col-xs-12 col-lg-12">
  <div class="box-success box view-item col-xs-12 col-lg-12">
    ...
    <form id="stu-master-form" action="query/Resource_Detail.php" method="get">
  
    <div class="box box-solid box-info col-xs-12 col-lg-12 no-padding">
      <div class="box-header with-border">
         <h4 class="box-title"><i class="fa fa-info-circle"></i> Add Resource</h4>
      </div>
    <div class="box-body">
...
<label class="control-label" for="stuinfo-stu_first_name">Resource ID</label><input type="number" id="stuinfo-stu_first_name" name="resource_id" class="form-control"><div class="help-block"></div>
</div>    </div>
   ...
   <div class="col-xs-12 col-sm-12 col-lg-12 no-padding">
    <div class="col-xs-12 col-sm-4 col-lg-4">
  <div class="form-group field-stuinfo-stu_first_name required">
<label class="control-label" for="stuinfo-stu_first_name">Resource</label><input type="text" id="stuinfo-stu_first_name" name="resource" class="form-control"><div class="help-block"></div>
</div>    </div>

<div class="col-xs-12 col-sm-12 col-lg-12 no-padding">
    <div class="col-xs-12 col-sm-4 col-lg-4">
  <div class="form-group field-stuinfo-stu_first_name required">
<label class="control-label" for="stuinfo-stu_first_name">Count</label><input type="number" id="stuinfo-stu_first_name" name="count" class="form-control" ><div class="help-block"></div>
</div>    </div>
...
<label class="control-label" for="stuinfo-stu_dob">Purchase Date</label><input type="date" name="p_date" id="stuinfo-stu_dob" class="form-control">
...
<label class="control-label" for="stuinfo-stu_city">Warranty Period</label><input type="number"  name ="w_period"id="stuinfo-stu_city" class="form-control" ><div class="help-block"></div>
</div>    </div>
  ...
  <div class="col-xs-6">
      <a class="btn btn-default btn-block" href="/readyMadeCode/eduSec/index.php?r=student%2Fstu-master%2Findex">Cancel</a> </div>
    </div>
