...
<li><a href="?controller=admin&action=roomwise_student_details">Roomwise Student Detail</a></li>
<li class="active">Add Student</li>
</ul>

    <section class="content">
        <div class="col-xs-12">
  <div class="col-lg-4 col-sm-4 col-xs-12 no-padding"><h3 class="box-title"><i class="fa fa-plus"></i> Add Student</h3></div>
</div>
...
<div class="col-xs-12 col-lg-12">
  <div class="box-success box view-item col-xs-12 col-lg-12">
    ...
    <form id="stu-master-form" action="query/Roomwise_Detail.php" method="get">
  
    <div class="box box-solid box-info col-xs-12 col-lg-12 no-padding">
      <div class="box-header with-border">
         <h4 class="box-title"><i class="fa fa-info-circle"></i> Add Roomwise Student</h4>
      </div>
    <div class="box-body">
...
<label class="control-label" for="stuinfo-stu_first_name" required>Student ID</label><input type="text" id="stuinfo-stu_first_name" name="sid" class="form-control" required ><div class="help-block"></div>
</div>    </div>
...
<label class="control-label" for="stuinfo-stu_dob">Hostel No</label><input type="number" name="hostel_no" required class="form-control" >
...
<label class="control-label" for="stuinfo-stu_city">Room No</label><input type="number"  name ="room_no" required class="form-control" ><div class="help-block">
</div>
</div>    
</div>
...
function hello(){
  ...
  <div class="col-xs-6">
      <a class="btn btn-default btn-block" href="#">Cancel</a> </div>
    </div>
